...
movies_metadata = pd.read_csv('./movies_metadata.csv', error_bad_lines= 'coerce', engine = 'python')
...
cred_df = pd.read_csv('./credits.csv', engine = 'python', error_bad_lines=False)
key_df = pd.read_csv('./keywords.csv', engine = 'python', error_bad_lines = False)
...
rating = pd.read_csv('C:/Users/Samardeep/Untitled Folder/Movies Dataset/ratings_small.csv', error_bad_lines=False)
rating.head()
